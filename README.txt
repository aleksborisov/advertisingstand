...
a persistence unit "testappPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "testapp\pom.xml":
...
artifact ("testapp.war") is already built. You can build
